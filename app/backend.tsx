...
export default function BackendScreen() {
  const data = backendPath;
  
  // Progress will be dynamic in Phase 4. Currently set to a starting value (e.g. 0)
  const progress = 0;
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.roadmapCard}>
          ...
          <View style={styles.progressSection}>
            ...
            <ProgressBar progress={progress} color="#2563EB" />
          </View>
          ...
          <Pressable
            style={styles.button}
            onPress={() => router.push({ pathname: "/roadmap", params: { path: "backend" } })}
          >
